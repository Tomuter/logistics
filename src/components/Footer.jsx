...
const Footer = () => (
  ...
  >
    ...
    >
      ...
      <div
      className='flex-[1.5] w-full flex flex-row justify-evenly flex-wrap md:mt-0 mt-10'
      >
    ...
    >Office:No 8 Offa Road, Old Airport Area, Sokoto</p>
    <p
    className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'
    >Tel:+2348066374620</p>
    ...
    >
      <p
       className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'      
      >
      2022 Sughnen health logistics. All Rights Reserved
      </p>
      <div
